<footer class="w-full px-0 mx-0">
    <div class="grid grid-cols-[1fr_2fr_1fr] gap-12 mt-12 mb-4">
        <div class="col-span-1">
            ...
            <div class="grid grid-cols-5 py-5 items-center">
                ...
                <img src="./public/image/ic_pinterest.svg" class="w-6 h-auto" alt="" />
                <img src="./public/image/ic_ytb.svg" class="w-6 h-auto" alt="" />
            </div>
            <div>
                <p class="
            bg-black
