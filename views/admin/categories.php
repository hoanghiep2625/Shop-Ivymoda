                        ...
                        <tbody>
                            <?php foreach ($categories as $categorie): ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                                    <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= htmlspecialchars($categorie['id']) ?></td>
                                    <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= htmlspecialchars($categorie['name']) ?></td>
                                    <td>
                                        <a href="?action=chinh_sua_categories&id=<?= urlencode($categorie['id']) ?>"
                                            class="text-white bg-blue-500 p-1 rounded-lg hover:underline">
                                            Edit
                                        </a>
                                        <a href="?action=nhanh_con_categories&id=<?= urlencode($categorie['id']) ?>"
