    ...
    <div class="flex h-full">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="bg-white shadow px-4 py-2 flex justify-between items-center">
                <div class="text-lg font-bold">Danh mục con của "<?= $categorie['name'] ?>" -> "<?= $sub_category['name'] ?>"</div>
            </header>
            ...
            <main class="p-4 flex-grow bg-gray-100">
                <div class="bg-white p-6 shadow rounded">
                    <table id="export-table">
                        ...
                        <tbody>
                            <?php foreach ($sub_sub_categories as $sub_sub_categorie): ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                                    <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= htmlspecialchars($sub_sub_categorie['id']) ?></td>
                                    <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= htmlspecialchars($sub_sub_categorie['name']) ?></td>
                                    <td>
                                        <a href="?action=chinh_sua_categories&id=<?= urlencode($sub_sub_categorie['id']) ?>"
