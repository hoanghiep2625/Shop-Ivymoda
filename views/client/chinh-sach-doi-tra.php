...
<body class="mx-[8%]">
    ...
    <div class="flex gap-4 mb-[20px] mt-[90px] ">
        ...
        <div class="text-sm">Chính sách đổi trả</div>
    </div>
    <hr>
    <article class="">
        <div>
            <div class="flex grid grid-cols-[1fr_2fr] gap-10  justify-center">
                ...
                <div>
                    <div class="mb-8">
                        <div class="text-[24px] font-semibold mt-0 mr-0 mb-[10px] ml-0">
                            CHÍNH SÁCH ĐỔI HÀNG
                        </div><br>
                        <div class="text-[16px] font-bold mt-0 mr-0 mb-[10px] ml-0 mx-auto">
                            1. THỜI GIAN ĐỔI TRẢ
                        </div><br>
                        <div class="space-y-0.25  text-[16px] ">
                            <div>
                            ...
                            <div class="font-normal text-base">
                                Áp dụng tại tất cả các cửa hàng trên toàn hệ thống của IVY moda và <span class="font-"> Hệ thống Kho hàng
