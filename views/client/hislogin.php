                    ...
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                            <?php foreach ($hislogin as $login): ?>
                                <tr>
                                    <td class="border-b p-2"><?php echo htmlspecialchars($login['device']); ?></td>
                                    <td class="border-b p-2"><?php echo htmlspecialchars($login['ip_address']); ?></td>
                                    <td class="border-b p-2"><?php echo htmlspecialchars($login['user_agent']); ?></td>
                                    <td class="border-b p-2"><?php echo htmlspecialchars($login['device']); ?></td>
                                    <td class="border-b p-2"><?php echo htmlspecialchars($login['login_time']); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
