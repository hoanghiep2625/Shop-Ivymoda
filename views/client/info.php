    ...
    <article class="mt-[90px]">
        ...
        <div class="grid grid-cols-[1.2fr_5fr] gap-36">
            <div class="border rounded-tl-[40px] rounded-br-[40px] p-8 w-full h-[310px]">
                ...
                <hr class="my-6">
                <div class="pb-6 font-[550] text-[14px] flex gap-1 items-center">
            ...
            <div>
                ...
                <div class="grid grid-cols-[2fr_1fr] gap-8 my-10">
                    ...
                    <div>
                        ...
                        <input type="password" placeholder="Mật khẩu cũ" class="border p-3 w-full rounded-md mb-4">
                        <input type="password" placeholder="Mật khẩu mới" class="border p-3 w-full rounded-md mb-4">
                        <input type="password" placeholder="Nhập lại mật khẩu mới" class="border p-3 w-full rounded-md mb-4">
                        <div class="mt-4">
                            <a href="#" class="border border-black rounded-tl-[15px] rounded-br-[15px] w-full h-[50px] flex justify-center items-center hover:bg-black hover:text-white transition-all duration-300">
                                <button class="font-semibold">ĐỔI MẬT KHẨU</button>
                            </a>
                        </div>
                    </div>
                    <div>
