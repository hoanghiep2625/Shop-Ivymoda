...
<body class="mx-[8%]">
    ...
    <article class="mt-[90px]">
        ...
        <div class="grid grid-cols-[1.2fr_5fr] gap-36">
            <div class="border rounded-tl-[40px] rounded-br-[40px] p-8 w-full h-[350px]">
                ...
                <div class="mt-6 text-[14px]  font-[550] flex gap-1 items-center">
                    ...
                    <a href="?action=orders">Quản lý đơn hàng</a>
                </div>
                    ...
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                            <?php foreach ($orders as $order): ?>
                                <tr>
                                    <td class="border-b p-2"><?= htmlspecialchars($order['order_id']) ?></td>
                                    <td class="border-b p-2"><?= htmlspecialchars($order['order_date']) ?></td>
                                    <td class="border-b p-2"><?= htmlspecialchars($order['status']) ?></td>
                                    <td class="border-b p-2"><?= number_format($order['total_price'], 0, ',', '.') ?> VNĐ</td>
