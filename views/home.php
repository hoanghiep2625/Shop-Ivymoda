...
<body class="mx-[120px]">
  ...
  <hr />
  <article class="h-64 mx-[150px]">
    <div class="grid grid-cols-2 divide-x divide-gray-300 gap-32">
      <div class="h-[250] flex flex-col items-center">
        ...
        <div class="border w-[80%] h-11 flex items-center p-4 mb-6"><input type="text" placeholder="Email/SĐT"
            class="text-[14px]"></div>
        <div class="border w-[80%] h-11 flex items-center p-4"><input type="text" placeholder="Mật khẩu"
            class="text-[14px]">
        </div>
      </div>
...
<footer class="w-full px-0 mx-0">
  <div class="grid grid-cols-[1fr_2fr_1fr] gap-12 mt-12">
    ...
    <div>
      ...
      <div class="text-2xl font-bold py-4">Download App</div>
